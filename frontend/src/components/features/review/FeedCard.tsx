        ...
        <div className="bg-[#0D1117] rounded-lg p-6 shadow-md border border-white/10 hover:border-[var(--color-lightgreen)] transition duration-200">
            ...
            <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-400">{new Date(reviewDate).toLocaleDateString("pt-BR")}</p>
                </div>
            </div>
            ...
            <div className="flex gap-4 mb-4">
                ...
                <div className="flex flex-col justify-between">
                    <div>
                        <h3 className="text-white font-bold text-lg hover:text-[var(--color-lightgreen)] transition cursor-pointer"
                            onClick={() => handleMediaClick()}
                        >{media.title}</h3>
