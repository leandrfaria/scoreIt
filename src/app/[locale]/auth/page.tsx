...
      // Traduz a mensagem de erro se for a específica do backend
...
      // A mágica acontece aqui: A mensagem já vem pronta do backend
...
                          {tSign("Select_Gender")}
                        </option>
                        <option value="MASC" className="bg-gray-800">
                       D    {tSign("M_Gender")}
                        </option>
                        <option value="FEM" className="bg-gray-800">
                          {tSign("F_Gender")}
                        </option>
