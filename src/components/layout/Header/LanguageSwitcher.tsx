...
export default function LanguageSwitcher() {
  ...
  const changeLanguage = async (newLocale: string) => {
    ...
    try {
      ...
      // Substitui o prefixo do locale atual pelo novo
      ...
      // Fallback caso algo dê errado ao montar a URL
      try {
      ...
      // provavelmente não executa antes do redirect, mas mantém por segurança
